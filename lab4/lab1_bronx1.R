...
bronx1<-read.xlsx("C:/Users/dingj/Desktop/data_analytics/lab4/rollingsales_bronx.xls",pattern="BOROUGH",stringsAsFactors=FALSE,sheetIndex=1,startRow=5,header=TRUE)
View(bronx1)
#
